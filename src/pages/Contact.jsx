          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="mailto:your.email@university.edu" className="academic-link text-lg">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-700">University City, State</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <Button variant="outline" size="sm" asChild>
                <a href="https://github.com/researcher" target="_blank" rel="noopener noreferrer">
                  Visit
                </a>
              </Button>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button variant="outline" size="sm" asChild>
                <a href="https://linkedin.com/in/researcher" target="_blank" rel="noopener noreferrer">
                  Connect
                </a>
              </Button>
            </div>
